/*Coby Hong and Dhruv Singal.
  The framerate has been slowed to allow one to see the creation of the tentacles.
  The pillars are generated using a sequence of ellipses with shadows and the vines are created
  using sine and cosing curves parametrically. Unfortunately, trying to make them also dynamically generated wasn't
  possible as it introduced too much lag in the rest of the program when it was put in draw().
  Tiled Element: pillars: 16 copies
  Parametric dynamic art: Tentacles
*/
var Z,Z1;
function setup()
{ frameRate(20);
...
//function to make hanging vines dynamically
